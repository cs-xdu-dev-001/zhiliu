...
def test_seed_creates_admin_and_demo_content_once(db_session: Session) -> None:
    from app.seed import seed_database

    seed_database(db_session, username="admin", password="secret", demo_mode=True)
    seed_database(db_session, username="admin", password="secret", demo_mode=True)
...
def test_seed_without_demo_only_creates_admin(db_session: Session) -> None:
    from app.seed import seed_database

    seed_database(db_session, username="admin", password="secret", demo_mode=False)
